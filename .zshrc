...
alias master-rebase="git fetch origin master && git rebase origin/master"
alias setup-rails="bundle && RAILS_ENV=development bin/rails db:migrate"
alias setup-web="yarn && yarn refresh-graphql"
